...
{
 send_custom_message    -filepath "c:\temp\vm_mapi_information_II.html" -messagetext "jack is back" -subject "Microsoft Azure Subscription Resource Usage $dates" -to "$user"
 }
