...
$subscriptioninfo = Get-AzSubscription -SubscriptionName 'wolffentpsub' -tenant $($azcontext.Context.Tenant.Id)

az role assignment create `
  --assignee-object-id 23800107-58e8-4bd2-bee6-94c0e5bc785b `
  --role "Reader" `
...
$servichealthapi = "https://management.azure.com/subscriptions/5755893a-8056-4ba8-9916-1133c80a80f3/providers/Microsoft.ResourceHealth/events?api-version=2024-02-01&queryStartTime=$startDate"
