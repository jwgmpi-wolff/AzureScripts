...
###############################################################################
  ...
  { 
       ...
       write-host " $billingaccount " -ForegroundColor green
...
######################  Commercial 
       ...
       $requesturi = "https://management.azure.com/$billingaccount/providers/Microsoft.CostManagement/query?api-version=2023-11-01"
  ...
  ########################  Usage collection 
              ...
              $usagerequesturi=  "https://management.azure.com/subscriptions/$billingScope/providers/Microsoft.Consumption/usageDetails?api-version=2023-11-01&$expand=properties/additionalProperties"
