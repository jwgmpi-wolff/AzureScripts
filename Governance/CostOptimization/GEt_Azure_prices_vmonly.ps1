...
type                 , `
unitOfMeasure        , `
unitPrice    | Where-Object {$_.productname -like "Virtual Machine*" -and $_.isPrimaryMeterRegion -eq 'True'  }    | export-csv $resultsfilename -NoTypeInformation
...
type                 , `
unitOfMeasure        , `
unitPrice       | Where-Object {$_.productname -like "Virtual Machine*" -and $_.isprimarymeterregion -eq 'True'  }    |  export-csv c:\temp\azure_prices.csv -NoTypeInformation
