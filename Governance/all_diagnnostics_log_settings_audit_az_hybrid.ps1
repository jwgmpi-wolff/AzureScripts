...
Write-Host "Scan complete. Results saved to AllLegacyDiagnosticSettings.csv"



$CSS = @"
<Title>All Diagnostic Logs settings Audit Report: $(Get-Date -Format 'dd MMMM yyyy') - Compliance Status</Title>
<Header>
...
$Diagnostic_report | Out-File c:\temp\all_diag_logs_settings.html 
invoke-item  c:\temp\all_diag_logs_settings.html
