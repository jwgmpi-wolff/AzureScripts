...
#https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/reference-audit-activities
    ...
    Get-AzureADAuditDirectoryLogs -All  $true | where-object {$_.ActivityDisplayName -like '*regist*'}
...
pullCriticalAADAuditLogs | select ActivityDateTime, Result, ActivityDisplayName, InitiatedBy, Target