...
function call_ai_foundry
{
    ...
    function Show-Help {
        ...
        Write-Host "  .\wolff_ai_foundry_call_HC_noreasoning_cleanonly_poc2.ps1 'your prompt here' [-Endpoint https://<project>.services.ai.azure.com/models] [-ApiKey <key>] [-UseEntraIDToken] [-Model gpt-4o-mini] [-Temperature 0.8] [-ShowUsage] [-ShowFullResponse]"
...
Export-ModuleMember -Function call_ai_foundry
