...
$nameOfResourceGroup = "$($rg.resourcegroupname)"
 ...
 <#       if($null -eq $RG)
        ...
        #    New-AzActivityLogAlert -Location $location -Name $nameOfAlertRule -ResourceGroupName $nameOfResourceGroup -Scope $subScope -Action $actionGroupsHashTable -Condition $condition1, $condition2,$condition3 `
